...
export default function Services() {
  ...
  return (
    <section id="services" className="bg-[#051B5A] w-full">
      <div
        style={bg}
        className="flex flex-col items-center justify-start w-full px-4 pt-32 pb-44 gap-14 sm:px-10 md:px-20 lg:px-36"
      >
        ...
        <div className="grid w-full grid-cols-2 mt-20">
          ...
          <div className={`w-full h-[${stack.src}px] border`}>
            <Image alt="" src={stack.src} width={700} height={stack.height} />
          </div>
        </div>
      </div>
    </section>
